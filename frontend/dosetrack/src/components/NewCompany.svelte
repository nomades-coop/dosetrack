<script>
  ...
  const doPost = async (data) => {
    ...
    if (res.ok) {
      ...
      if (res.status === 409) {
        ...
        errors["company_name"]["error"].push(["La empresa ya ha sido registrada"])
        errors["company_cuit"]["error"].push(["La empresa ya ha sido registrada"])
  ...
  const validateForm = (data) => { 
    ...
    setError(errors, data, "company_name", isRequiredRule, "Este dato es obligatorio");
    setError(errors, data, "company_cuit", isRequiredRule, "Este dato es obligatorio");
    setError(errors, data, "company_status", isRequiredRule, "Este dato es obligatorio");
    setError(errors, data, "user_name", isRequiredRule, "Este dato es obligatorio");
    setError(errors, data, "user_last_name", isRequiredRule, "Este dato es obligatorio");
    setError(errors, data, "user_status", isRequiredRule, "Este dato es obligatorio");
...
<div class="mb-3">
  ...
  />
  <div id="company_cuitHelp" class="form-text">Identificador ante el ente impositivo</div>
...
<div class="mb-3">
  ...
  <input
    ...
    class="form-control"
    name="user_name"
    id="user_name" value={$user.given_name}
    maxlength="100"
...
<div class="mb-3">
  ...
  <input
    ...
    class="form-control"
    name="user_last_name"
    id="user_last_name" value={$user.family_name}
    maxlength="100"
...
<div class="mb-3">
  ...
  <input
    ...
    maxlength="100"
    aria-describedby="user_emailHelp" readonly
  />
